...
import {
	BsArrowRight, BsFillSquareFill,
} from "react-icons/bs";
import ContactUs from "../../contactUs";
import {techs} from "../../../publicassets/healthcare";
import Projects from "./ManagedItServices/Projects";
				...
				<Container maxW={"7xl"} px={{ lg: "5rem", base: "2rem" }} bg={{ base: "#F7F2FA", lg: "white" }}>
					...
					<Flex gap={"5rem"} justify={"center"} mb={"7rem"} mt={"4rem"}>
						...
						<Box width={{ base: '100%', lg: '70%'}}>
							...
							<Text fontWeight={'700'} fontSize={{lg:"32px", base:"18px"}}
									 lineHeight={'44px'}>Healthcare IT Infrastructure Components We Support</Text>
							<Box
							...
							<Box  mt={"4rem"} id="About_us" scrollMarginTop={"150px"}>
								<Text
									fontWeight={'400'}
									fontSize='20px'
									lineHeight={'170%'}>We provide the following services separately or in combination.
								</Text>
								<Heading
									fontWeight="600"
							...
							<Box mt={"4rem"} id="SWE" scrollMarginTop={"150px"} >
								...
								<Grid gridTemplateColumns={{ base: '1fr', lg: 'repeat(3, 1fr)'}} gap={'2rem'} my={'2rem'}>
									{servicePackage.map((item, index) => (
										<Card w={{ base: '33%', lg: '100%' }} key={index}
											  display={'flex'}
											  justify={'center'}
											  align={'center'}
											  flexDir={'column'}
											...
											<Text fontWeight='700'
												  fontSize='18px'
												  lineHeight='25px'>{item?.subtitle}</Text>
											<Text fontWeight='400'
												  fontSize='16px'
												  lineHeight='25px'>{item?.text}</Text>

											<Link href={'/contact-us'} style={{ border: '2px solid red',
												borderRadius: '6px',
												display: 'flex',
												justifyContent: 'center',
												alignItems: 'center',
							...
							<Box mt={"2rem"} scrollMarginTop={"150px"}>
								<Flex
									flexDirection={"column"}
									marginLeft={{ lg: "15px", base: "0" }}
								>
							...
							{/* Investments section */}
							<Box mt={"1rem"} scrollMarginTop={"150px"}>
								<Flex
									flexDirection={"column"}
									marginLeft={{ lg: "15px", base: "0" }}
								>
							...
							{/* featured projects */}
							<Box id={'selected'} scrollMarginTop={"150px"}>
								<Projects />
							</Box>
