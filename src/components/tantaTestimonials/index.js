...
import {Modal, ModalOverlay, ModalContent, ModalBody, ModalCloseButton, Button, Text, Flex} from "@chakra-ui/react";
import {ImQuotesLeft} from "react-icons/im";

const TantaTestimonial = ({ testimonials }) => {
	const [showMore, setShowMore] = useState(false);
	const [modalOpen, setModalOpen] = useState(false);
	const [selectedTestimonial, setSelectedTestimonial] = useState(null); // New state to store the selected testimonial
	...
	return (
		<Container>
			...
			<Swiper
				...
				onSlideChange={() => setShowMore(false)}
				spaceBetween={50}
				slidesPerView={1}
				navigation
			...
			<Modal isOpen={modalOpen} onClose={toggleModal}>
				...
				<ModalContent>
					<ModalBody>
						<Flex justify={'flex-start'}><ImQuotesLeft size={50}/></Flex>
...
export default TantaTestimonial;
