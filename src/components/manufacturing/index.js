...
import {approach, services, sideBarData, solutions} from "./data";
                    ...
                    <Container maxW={"7xl"}>
                        <HeroContent>
                            ...
                            <HeroText>
                                ...
                                <p>
                                    With over 15 years of experience in the software development industry, Tantain
                                    specializes in providing robust solutions and related services tailored specifically
                                    for the manufacturing industry. Our comprehensive offerings are designed to support
                                    and modernize your enterprise's operations, resulting in increased efficiency and
                        ...
                        <Text fontSize={{lg:"lg", base:"16px"}} mt={"1rem"}>
                            Our manufacturing-focused IT solutions optimize operations throughout the supply chain, from
                            management to sales. This enhances productivity and reduces operational expenses for
                            companies.
                        </Text>
                        <Box mb={"2rem"} mt={"4rem"}>
                            <Flex gap={"2rem"} justify={"center"}>
                                ...
                                <Box flex={3} mb={"2rem"} pl={"2rem"} className="about-box">
                                    <Box id="whyChoose" scrollMarginTop={"150px"}>
                                        <WhyChoose/>
                                    </Box>
                                    <Box id="approach" scrollMarginTop={"20px"}>
                                        <Services>
                                    ...
                                    <Box id="capacity" scrollMarginTop={"50px"}>
                                        <Services>
                                            <div className="services">
                                                <h3>
                                                    <span>Our Capabilities </span>in Manufacturing IT
                                                    Services
                                                </h3>
                                    ...
                                    <Box id="chooseUs" scrollMarginTop={"30px"}>
                                        <Services>
                                            <div className="services">
                                                <h3>
                                    ...
                                    <Box id="contact" scrollMarginTop={"150px"}>
                                        <NeedExpert/>
                                    </Box>
                                </Box>
                            </Flex>
