...
function  NotAuthorized () {
    ...
    return(
        <Box   position={"relative"}>
            ...
            <Box  backgroundImage="url('/assets/authenticationPages/Shape.png')" height={"30.5rem"} width={"100%"}
                  position={"absolute"}
            ...
            >
                <Image
                    src={"/assets/authenticationPages/you-are-not-authorized.png"}
                    alt="tanta logo"
                    width={100}
                    height={100}
                />
            ...
            <Box    width="100%" textAlign="center"
                    top={{base: "5rem", md: "20rem", lg: "15rem"}}
            ...
            >
                ...
                <Button  mt={{base: "3rem", md: "3rem", lg: "1rem"}}
